...
export const CONSTANTS = {
  ...
  IMAGE_ROOT: `${PUBLIC_URL}/assets/cards/`,
  CARD_BACK_IMAGE: `${PUBLIC_URL}/assets/back.png`,
  PLACEHOLDER_IMAGE: `${PUBLIC_URL}/assets/back.png`,
    MOBILE_QUERY: '(max-width: 540px)',
    CART_STORAGE_KEY: 'pokemart-cart-v1',
    THEME_KEY: 'pokemart-theme',
    HERO_LIGHT_IMAGE: `${PUBLIC_URL}/assets/cards/charizarday.png`,
    HERO_LIGHT_ALT: 'Charizard arte diurno Carta Destacada',
    HERO_DARK_IMAGE: `${PUBLIC_URL}/assets/Charizard_ex.png`,
    HERO_DARK_ALT: 'Charizard EX Carta Destacada',
    HERO_BACK_IMAGE: `${PUBLIC_URL}/assets/back.png`,
