        ...
        >
          ...
          >
            <div className="user-actions">
              ...
              {/* Fila de iconos: en mobile se agrupa horizontalmente */}
              <div className="header-icon-row" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <button
                  className="header-sell cart-icon flex items-center justify-center transition-transform hover:-translate-y-1"
                  type="button"
                  aria-label="Ver carrito"
                  onClick={() => { onCartClick(); isMenuMobile && setMenuOpen(false); }}
                ...
                <div className="user-profile flex items-center relative user-menu-container">
                  {user ? (
                    ...
                    <button
                      className="header-sell flex items-center justify-center transition-transform hover:-translate-y-1"
                      style={{ background: 'none', border: 'none', padding: '0', cursor: 'pointer' }}
                      onClick={() => { setIsAuthModalOpen(true); isMenuMobile && setMenuOpen(false); }}
